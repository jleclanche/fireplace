...
class RandomCardPicker(LazyValue):
	...
	def find_cards(self, source=None, **filters):
		...
		from .. import cards
		cards_set = cards.filter(**new_filters)
		# Quests cannot be randomly generated by 'outside-of-game' effects
		filter(lambda card: not(card.quest), cards_set)
		return cards_set
...
RandomElemental = lambda **kw: RandomCardPicker(race=Race.ELEMENTAL)
